...
// create an event listener
 useEffect(() => {
    ...
    <header className={location.pathname !== '/' ? otherClass : (isMobile ? otherClass : homeClass)}>
        <nav id="nav" className="navbar navbar-expand-md fixed-top ">
            <div className="container-fluid d-flex justify-content-between">
                <div className="d-flex align-items-center mb-md-0 me-md-auto">
                ...
                <div className="collapse navbar-collapse px-2 " id="navbarCollapse">
                    ...
                    <li><NavLink to="/" className={(({ isActive }) => isActive ? activeClassName : inActiveClass)} end>Home</NavLink></li>
                        ...
                        <li><NavLink to="/about" className={(({ isActive }) => isActive ? activeClassName : inActiveClass)} end>About</NavLink></li>
